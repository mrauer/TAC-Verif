...
public class DigestUtil {
    ...
    public static ASN1ObjectIdentifier getDigestOID(String string) {
        ASN1ObjectIdentifier aSN1ObjectIdentifier = (ASN1ObjectIdentifier)nameToOid.get((Object)string);
        if (aSN1ObjectIdentifier != null) {
            return aSN1ObjectIdentifier;
        }
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline18((String)"unrecognized digest name: ", (String)string));
    }
}
