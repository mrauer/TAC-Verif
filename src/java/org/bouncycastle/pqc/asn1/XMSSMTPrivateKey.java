...
extends ASN1Object {
    ...
    public XMSSMTPrivateKey(long l2, byte[] arrby, byte[] arrby2, byte[] arrby3, byte[] arrby4, byte[] arrby5) {
        this.version = 0;
        this.index = l2;
    ...
    public XMSSMTPrivateKey(long l2, byte[] arrby, byte[] arrby2, byte[] arrby3, byte[] arrby4, byte[] arrby5, long l3) {
        this.version = 1;
        this.index = l2;
        this.secretKeySeed = Nat576.clone(arrby);
        this.secretKeyPRF = Nat576.clone(arrby2);
            ...
            block8 : {
                ...
                block6 : {
                    block7 : {
                        ...
                        l2 = ASN1Integer.getInstance(aSN1TaggedObject, false).longValueExact();
                        break block8;
                    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        ASN1Integer aSN1Integer = this.maxIndex >= 0L ? new ASN1Integer(1L) : new ASN1Integer(0L);
        ...
        long l2 = this.maxIndex;
        if (l2 >= 0L) {
            aSN1EncodableVector2.add(new DERTaggedObject(false, 0, new ASN1Integer(l2)));
        }
