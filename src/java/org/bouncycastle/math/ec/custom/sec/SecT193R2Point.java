...
extends ECPoint.AbstractF2m {
    ...
    public SecT193R2Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] arreCFieldElement) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (eCFieldElement8.isZero()) {
            ...
            if (eCFieldElement3.isZero()) {
                return new SecT193R2Point(eCCurve, eCFieldElement3, eCCurve.b.sqrt());
            }
            ...
            if (eCFieldElement21.isZero()) {
                return new SecT193R2Point(eCCurve, eCFieldElement21, eCCurve.b.sqrt());
            }
        ...
        return new SecT193R2Point(eCCurve, eCFieldElement3, eCFieldElement, new ECFieldElement[]{eCFieldElement6});
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElement7.isZero()) {
            return new SecT193R2Point(eCCurve, eCFieldElement7, eCCurve.b.sqrt());
        }
        ...
        return new SecT193R2Point(eCCurve, eCFieldElement8, eCFieldElement.squarePlusProduct(eCFieldElement7, eCFieldElement4).add(eCFieldElement8).add(eCFieldElement9), new ECFieldElement[]{eCFieldElement9});
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (!eCFieldElement2.isZero() && eCFieldElement3.isOne()) {
            ...
            if (eCFieldElement13.isZero()) {
                return new SecT193R2Point(eCCurve, eCFieldElement13, eCCurve.b.sqrt());
            }
            ...
            return new SecT193R2Point(eCCurve, eCFieldElement16, eCFieldElement13.add(eCFieldElement15).square().multiplyPlusProduct(eCFieldElement11, eCFieldElement12, eCFieldElement17), new ECFieldElement[]{eCFieldElement17});
        }
