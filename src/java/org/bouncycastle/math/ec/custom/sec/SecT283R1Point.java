...
extends ECPoint.AbstractF2m {
    ...
    public SecT283R1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] arreCFieldElement) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (eCFieldElement8.isZero()) {
            ...
            if (eCFieldElement2.isZero()) {
                return new SecT283R1Point(eCCurve, eCFieldElement2, eCCurve.b.sqrt());
            }
            ...
            if (eCFieldElement21.isZero()) {
                return new SecT283R1Point(eCCurve, eCFieldElement21, eCCurve.b.sqrt());
            }
        ...
        return new SecT283R1Point(eCCurve, eCFieldElement2, eCFieldElement4, new ECFieldElement[]{eCFieldElement6});
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElement6.isZero()) {
            return new SecT283R1Point(eCCurve, eCFieldElement6, eCCurve.b.sqrt());
        }
        ...
        return new SecT283R1Point(eCCurve, eCFieldElement7, eCFieldElement2.squarePlusProduct(eCFieldElement6, eCFieldElement5).add(eCFieldElement7).add(eCFieldElement8), new ECFieldElement[]{eCFieldElement8});
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (!eCFieldElement2.isZero() && eCFieldElement3.isOne()) {
            ...
            if (eCFieldElement12.isZero()) {
                return new SecT283R1Point(eCCurve, eCFieldElement12, eCCurve.b.sqrt());
            }
            ...
            return new SecT283R1Point(eCCurve, eCFieldElement15, eCFieldElement12.add(eCFieldElement14).square().multiplyPlusProduct(eCFieldElement11, eCFieldElement6.addOne(), eCFieldElement16), new ECFieldElement[]{eCFieldElement16});
        }
