...
import org.bouncycastle.math.ec.custom.sec.SecT283R1Curve$1;
import org.bouncycastle.math.ec.custom.sec.SecT283R1Point;
import org.bouncycastle.util.encoders.Hex;

public class SecT283R1Curve
extends ECCurve.AbstractF2m {
    public static final ECFieldElement[] SECT283R1_AFFINE_ZS;
    public SecT283R1Point infinity = new SecT283R1Point(this, null, null);

    public static {
        ECFieldElement[] arreCFieldElement = new ECFieldElement[]{new SecT283FieldElement(ECConstants.ONE)};
        SECT283R1_AFFINE_ZS = arreCFieldElement;
    }

    public SecT283R1Curve() {
        super(283, 5, 7, 12);
        this.a = new SecT283FieldElement(BigInteger.valueOf((long)1L));
        this.b = new SecT283FieldElement(new BigInteger(1, Hex.decodeStrict("027B680AC8B8596DA5A4AF8A19A0303FCA97FD7645309FA2A581485AF6263E313B79A2F5")));
    ...
    public AbstractECLookupTable createCacheSafeLookupTable(ECPoint[] arreCPoint, int n2, int n3) {
        ...
        return new SecT283R1Curve$1(this, n3, arrl);
    }
