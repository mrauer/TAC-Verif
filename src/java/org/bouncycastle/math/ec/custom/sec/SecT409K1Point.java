...
extends ECPoint.AbstractF2m {
    ...
    public SecT409K1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] arreCFieldElement) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (eCFieldElement8.isZero()) {
            ...
            if (eCFieldElement3.isZero()) {
                return new SecT409K1Point(eCCurve, eCFieldElement3, eCCurve.b);
            }
            ...
            if (eCFieldElement21.isZero()) {
                return new SecT409K1Point(eCCurve, eCFieldElement21, eCCurve.b);
            }
        ...
        return new SecT409K1Point(eCCurve, eCFieldElement3, eCFieldElement, new ECFieldElement[]{eCFieldElement6});
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElement5.isZero()) {
            return new SecT409K1Point(eCCurve, eCFieldElement5, eCCurve.b);
        }
        ...
        return new SecT409K1Point(eCCurve, eCFieldElement6, eCFieldElement8.add(eCFieldElement5).add(eCFieldElement4).multiply(eCFieldElement8).add(eCFieldElement3).add(eCFieldElement6).add(eCFieldElement7), new ECFieldElement[]{eCFieldElement7});
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (!eCFieldElement2.isZero() && eCFieldElement3.isOne()) {
            ...
            if (eCFieldElement12.isZero()) {
                return new SecT409K1Point(eCCurve, eCFieldElement12, eCCurve.b);
            }
            ...
            return new SecT409K1Point(eCCurve, eCFieldElement15, eCFieldElement12.add(eCFieldElement14).square().multiplyPlusProduct(eCFieldElement10, eCFieldElement11, eCFieldElement16), new ECFieldElement[]{eCFieldElement16});
        }
