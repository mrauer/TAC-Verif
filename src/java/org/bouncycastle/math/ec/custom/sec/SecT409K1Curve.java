...
import org.bouncycastle.math.ec.custom.sec.SecT409K1Curve$1;
import org.bouncycastle.math.ec.custom.sec.SecT409K1Point;
import org.bouncycastle.util.encoders.Hex;

public class SecT409K1Curve
extends ECCurve.AbstractF2m {
    public static final ECFieldElement[] SECT409K1_AFFINE_ZS;
    public SecT409K1Point infinity = new SecT409K1Point(this, null, null);

    public static {
        ECFieldElement[] arreCFieldElement = new ECFieldElement[]{new SecT409FieldElement(ECConstants.ONE)};
        SECT409K1_AFFINE_ZS = arreCFieldElement;
    }

    public SecT409K1Curve() {
        super(409, 87, 0, 0);
        this.a = new SecT409FieldElement(BigInteger.valueOf((long)0L));
        this.b = new SecT409FieldElement(BigInteger.valueOf((long)1L));
    ...
    public AbstractECLookupTable createCacheSafeLookupTable(ECPoint[] arreCPoint, int n2, int n3) {
        ...
        return new SecT409K1Curve$1(this, n3, arrl);
    }
