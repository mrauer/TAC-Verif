...
import org.bouncycastle.math.ec.custom.sec.SecT163K1Curve$1;
...
extends ECCurve.AbstractF2m {
    public static final ECFieldElement[] SECT163K1_AFFINE_ZS;
    ...
    public static {
        ...
        SECT163K1_AFFINE_ZS = arreCFieldElement;
    }

    public SecT163K1Curve() {
        super(163, 3, 6, 7);
        SecT163FieldElement secT163FieldElement = new SecT163FieldElement(BigInteger.valueOf((long)1L));
        this.a = secT163FieldElement;
    ...
    public AbstractECLookupTable createCacheSafeLookupTable(ECPoint[] arreCPoint, int n2, int n3) {
        ...
        return new SecT163K1Curve$1(this, n3, arrl);
    }
