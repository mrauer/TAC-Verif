...
import org.bouncycastle.math.ec.custom.sec.SecP160K1Curve$1;
...
extends ECCurve.AbstractFp {
    public static final ECFieldElement[] SECP160K1_AFFINE_ZS;
    ...
    public static {
        ...
        SECP160K1_AFFINE_ZS = arreCFieldElement;
    }

    public SecP160K1Curve() {
        super(q);
        this.a = new SecP160R2FieldElement(ECConstants.ZERO);
        this.b = new SecP160R2FieldElement(BigInteger.valueOf((long)7L));
    ...
    public AbstractECLookupTable createCacheSafeLookupTable(ECPoint[] arreCPoint, int n2, int n3) {
        ...
        return new SecP160K1Curve$1(this, n3, arrn);
    }
