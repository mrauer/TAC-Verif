...
public class SecP224K1Field {
    ...
    public static void reduce(int[] arrn, int[] arrn2) {
        ...
        arrn2[2] = (int)l10;
        long l11 = l10 >>> 32;
        long l12 = 0xFFFFFFFFL & (long)arrn[10];
        long l13 = l11 + (l9 + l2 * l12 + (0xFFFFFFFFL & (long)arrn[3]));
        arrn2[3] = (int)l13;
        long l14 = l13 >>> 32;
        long l15 = 0xFFFFFFFFL & (long)arrn[11];
        long l16 = l14 + (l12 + l2 * l15 + (0xFFFFFFFFL & (long)arrn[4]));
        arrn2[4] = (int)l16;
        long l17 = l16 >>> 32;
        long l18 = 0xFFFFFFFFL & (long)arrn[12];
        long l19 = l17 + (l15 + l2 * l18 + (0xFFFFFFFFL & (long)arrn[5]));
        arrn2[5] = (int)l19;
        long l20 = l19 >>> 32;
        long l21 = 0xFFFFFFFFL & (long)arrn[13];
        long l22 = l20 + (l18 + l2 * l21 + (0xFFFFFFFFL & (long)arrn[6]));
        arrn2[6] = (int)l22;
        long l23 = l21 + (l22 >>> 32);
        long l24 = l23 & 0xFFFFFFFFL;
        long l25 = 0L + (l2 * l24 + (0xFFFFFFFFL & (long)arrn2[0]));
        arrn2[0] = (int)l25;
        long l26 = l25 >>> 32;
        long l27 = l23 >>> 32;
        long l28 = l26 + (l24 + l2 * l27 + (0xFFFFFFFFL & (long)arrn2[1]));
        arrn2[1] = (int)l28;
        long l29 = (l28 >>> 32) + (l27 + (0xFFFFFFFFL & (long)arrn2[2]));
        arrn2[2] = (int)l29;
        long l30 = (l29 >>> 32) + (0xFFFFFFFFL & (long)arrn2[3]);
        arrn2[3] = (int)l30;
        int n2 = l30 >>> 32 == 0L ? 0 : Nat576.incAt(7, arrn2, 0, 4);
        if (n2 != 0 || arrn2[6] == -1 && SecT239Field.gte3(arrn2, P)) {
            Nat576.add33To(7, 6803, arrn2);
        }
    }
        ...
        block4 : {
            block3 : {
                block2 : {
                    ...
                    arrn[2] = (int)l6;
                    int n3 = l6 >>> 32 == 0L ? 0 : Nat576.incAt(7, arrn, 0, 3);
                    if (n3 != 0) break block3;
                }
                if (arrn[6] != -1 || !SecT239Field.gte3(arrn, P)) break block4;
            }
