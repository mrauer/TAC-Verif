...
public final class Example6 {
    ...
    public static /* varargs */ void main(String ... arrstring) throws IOException, ProcessingException {
        ...
        URITranslatorConfiguration uRITranslatorConfiguration = URITranslatorConfiguration.newBuilder().addSchemaRedirect(FROM, TO).freeze();
        ...
        JsonSchema jsonSchema = JsonSchemaFactory.newBuilder().setLoadingConfiguration(loadingConfiguration).freeze().getJsonSchema(FROM);
