...
public final class Example5 {
    ...
    public static /* varargs */ void main(String ... arrstring) throws IOException, ProcessingException {
        ...
        URITranslatorConfiguration uRITranslatorConfiguration = URITranslatorConfiguration.newBuilder().setNamespace(NAMESPACE).freeze();
        ...
        JsonSchema jsonSchema = JsonSchemaFactory.newBuilder().setLoadingConfiguration(loadingConfiguration).freeze().getJsonSchema("fstab.json");
