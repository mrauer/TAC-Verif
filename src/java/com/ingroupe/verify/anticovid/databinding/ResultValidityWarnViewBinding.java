...
public final class ResultValidityWarnViewBinding
implements ViewBinding {
    ...
    public ResultValidityWarnViewBinding(ConstraintLayout constraintLayout, ImageView imageView, TextView textView) {
