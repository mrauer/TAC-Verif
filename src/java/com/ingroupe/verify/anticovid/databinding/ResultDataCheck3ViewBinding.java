...
public final class ResultDataCheck3ViewBinding
implements ViewBinding {
    ...
    public ResultDataCheck3ViewBinding(ConstraintLayout constraintLayout, ImageView imageView, TextView textView, TextView textView2) {
