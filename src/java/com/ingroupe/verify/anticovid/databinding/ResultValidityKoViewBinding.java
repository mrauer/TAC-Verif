...
public final class ResultValidityKoViewBinding
implements ViewBinding {
    ...
    public ResultValidityKoViewBinding(ConstraintLayout constraintLayout, ImageView imageView, TextView textView) {
