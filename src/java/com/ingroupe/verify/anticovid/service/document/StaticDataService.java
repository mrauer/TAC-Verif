...
public final class StaticDataService {
    public static final String[] headersUsed = new String[]{"01", "02", "07", "08"};

    /*
     * Exception decompiling
     */
    public static final DocumentStaticDccResult getDcc(String var0, Context var1, Map<String, String> var2) {
